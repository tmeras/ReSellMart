...
import { ORDER_ITEM_STATUS_STEP } from "@/utils/constants.ts";
import { base64ToDataUri } from "@/utils/fileUtils.ts";
import { Button, Card, Divider, Flex, Image, Popover, Stepper, Text, useMantineColorScheme } from "@mantine/core";
import { IconArrowDown, IconCash, IconHome, IconTruckDelivery } from "@tabler/icons-react";
                    ...
                    <div key={ orderItem.id }>
                        <Flex w="100%" gap="sm" mb="xs">
                            ...
                            <Flex direction="column" maw="55%">
                                ...
                                <Stepper active={ ORDER_ITEM_STATUS_STEP[orderItem.status] } size="xs" mt="xl">
                                    <Stepper.Step
                                        label="Paid"
                                        ...
                                        color={
                                            (orderItem.status === "PENDING_SHIPMENT" || orderItem.status === "SHIPPED" ||
                                                orderItem.status === "DELIVERED") ? "teal" : ""
                                        }
                                    />
                                    ...
                                    <Stepper.Step
                                        ...
                                        color={ orderItem.status === "DELIVERED" ? "teal" : "" }
                                    />
                                </Stepper>
